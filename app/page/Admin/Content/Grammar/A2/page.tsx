...
import '@/app/page/Admin/Content/Grammar/A1/A1.css'; // Import CSS riêng cho trang này
...
const lessonData = [
   { 
    ...
    description: 'Học cách sử dụng thì hiện tại tiếp diễn cho hành động đang diễn ra.', 
    status: 'Đã xuất bản', 
    views: 1120, 
    updated: '2024-02-01' 
  },
  { 
    ...
    description: 'So sánh hơn và so sánh nhất: cách sử dụng tính từ và trạng từ.', 
    status: 'Bản nháp', 
    views: 550, 
    updated: '2024-01-30' 
  },
  { 
    ...
    description: 'Danh từ đếm được và không đếm được: Dùng "much", "many", "some", "any".', 
    status: 'Đã xuất bản', 
    views: 1480, 
    updated: '2024-01-28' 
  },
  { 
    ...
    description: 'Thì quá khứ đơn: Cấu trúc và cách sử dụng cho hành động đã xảy ra.', 
    status: 'Đã xuất bản', 
    views: 970, 
    updated: '2024-01-25' 
  },
  { 
    ...
    description: 'Diễn tả kế hoạch tương lai với cấu trúc "be going to".', 
    status: 'Đã xuất bản', 
    views: 890, 
    updated: '2024-01-22' 
  },
  { 
    ...
    description: 'Giới từ chỉ thời gian (at, on, in) và nơi chốn.', 
    status: 'Bản nháp', 
    views: 410, 
    updated: '2024-01-20' 
  },
  { 
    ...
    description: 'Câu điều kiện loại 1: Diễn tả điều kiện có thể xảy ra ở hiện tại/tương lai.', 
    status: 'Đã xuất bản', 
    views: 1050, 
    updated: '2024-01-18' 
  }
        ...
        <>
            ...
            >
                ...
                <div className="d-flex justify-content-between align-items-center mb-4" style={{ marginTop: '60px' }}>
                    <div>
                        <h2 className="fw-bold">Grammar Pre-intermediate</h2>
