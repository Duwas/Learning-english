...
const PRIMARY_COLOR = "#52c41a"; // Màu hồng đậm/Coral
const ACCENT_COLOR = "#ffe5e5"; // Màu hồng nhạt

const WritingTopicCard: React.FC<TopicCardProps> = ({
  id,
  name,
  description,
  level,
  ...
  const handleClick = () => {
    router.push(`/User/writing/test?topicId=${id}`);
  };
  // Xử lý đường dẫn ảnh (dùng placeholder khác nếu cần)
  const defaultPlaceholderUrl = "/img/writing_A1.png"; // Dùng ảnh placeholder khác cho Speaking
